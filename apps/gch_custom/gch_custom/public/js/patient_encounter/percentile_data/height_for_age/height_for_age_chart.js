...
frappe.require("/assets/gch_custom/js/patient_encounter/percentile_data/chart.js", function() {
    ...
    const TENSION = 0.2;
    var ctx = document.getElementById("heightAgeChart").getContext("2d");

    // Fetching Height chart data
    ...
    // GENERATING CHARTS FOR HEIGHT PERCENTILE MONTH 0 - 24
    ...
    if(totalMonths < 24) {
      ...
      if (totalMonths < 24 && cur_frm.doc.patient_sex == "Male") {
        ...
        zeroTo24 = "/assets/gch_custom/js/patient_encounter/percentile_data/height_for_age/boysHeightAge0To24.json"
      } else if (totalMonths < 24 && cur_frm.doc.patient_sex == "Female") {
        console.log("Female under 24 months")
        zeroTo24 = "/assets/gch_custom/js/patient_encounter/percentile_data/height_for_age/girlsHeightAge0To24.json"
      }
          ...
          new Chart(ctx, {
            ...
            options: {
              ...
              plugins: {
                title: {
                  display: true,
                  text: cur_frm.doc.patient + "'s Height for Age Growth Chart",
                },
              },
              scales: {
                x: {
      ...
      // GENERATING CHARTS FOR HEIGHT PERCENTILE MONTH 24 - 60

      // Check for patient sex and age to generate the right link
      var Twenty4to60
      if (totalMonths >= 24 && totalMonths < 60 && cur_frm.doc.patient_sex == "Male") {
        console.log("Male under 60 months")
        Twenty4to60 = "/assets/gch_custom/js/patient_encounter/percentile_data/height_for_age/boysHeightAge24To60.json"
      } else if (totalMonths > 24 && totalMonths < 60 && cur_frm.doc.patient_sex == "Female") {
        console.log("Female under 60 months")
        Twenty4to60 = "/assets/gch_custom/js/patient_encounter/percentile_data/height_for_age/girlsHeightAge24To60.json"
      }
      ...
      // GENERATING CHARTS FOR HEIGHT PERCENTILE MONTH 60 - 240

      // Check for patient sex and age to generate the right link
      var sixtyto240
      if (totalMonths >= 60 && totalMonths <= 240 && cur_frm.doc.patient_sex == "Male") {
        console.log("Male under 240 months")
        sixtyto240 = "/assets/gch_custom/js/patient_encounter/percentile_data/height_for_age/boysHeightAge60to240.json"
      } else if (totalMonths >= 60 && totalMonths <= 240 && cur_frm.doc.patient_sex == "Female") {
        console.log("Female under 240 months")
        sixtyto240 = "/assets/gch_custom/js/patient_encounter/percentile_data/height_for_age/girlsHeightAge60to240.json"
      }
