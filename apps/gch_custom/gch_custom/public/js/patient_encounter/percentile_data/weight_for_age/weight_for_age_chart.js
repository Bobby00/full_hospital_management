...
frappe.require("/assets/gch_custom/js/patient_encounter/percentile_data/chart.js", function() {
    ...
    frappe.call({
      ...
      callback: function (res) {
        ...
        $.each(res.message, function(_i, e){
          ...
          anthropometry_history.push([totalMonths, e.weight_in_kilograms])
    ...
    // GENERATING CHARTS FOR WEIGHT PERCENTILE MONTH 0 - 60

    if (totalMonths <= 60) {

      // Check for patient sex and age to generate the right link
      var zeroTo60
      if (totalMonths <= 60 && cur_frm.doc.patient_sex == "Male") {
        console.log("Male under 60 months")
        zeroTo60 = "/assets/gch_custom/js/patient_encounter/percentile_data/weight_for_age/boysWeightAge.json"
      } else if (totalMonths <= 60 && cur_frm.doc.patient_sex == "Female") {
        console.log("Female under 60 months")
        zeroTo60 = "/assets/gch_custom/js/patient_encounter/percentile_data/weight_for_age/girlsWeightAge.json"
      }
      ...
      fetch(
        ...
        .then((data) => (obj = data))
        .then(() => {
          // Generating chart for month 0 - 60
          ...
          new Chart(ctx, {
            ...
            options: {
              ...
              plugins: {
                title: {
                  display: true,
                  text: cur_frm.doc.patient + "'s Weight for Age Growth Chart",
                },
              },
              scales: {
                x: {
    ...
    // GENERATING CHARTS FOR WEIGHT PERCENTILE MONTH 60 - 240

    // Check for patient sex and age to generate the right link
    var sixtyto240
    if (totalMonths >= 60 && totalMonths <= 240 && cur_frm.doc.patient_sex == "Male") {
      console.log("Male under 240 months")
      sixtyto240 = "/assets/gch_custom/js/patient_encounter/percentile_data/weight_for_age/boysWeightAge60to240.json"
    } else if (totalMonths >= 60 && totalMonths <= 240 && cur_frm.doc.patient_sex == "Female") {
      console.log("Female under 240 months")
      sixtyto240 = "/assets/gch_custom/js/patient_encounter/percentile_data/weight_for_age/girlsWeightAge60to240.json"
    }
