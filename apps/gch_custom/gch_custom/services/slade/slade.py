...
class Slade:
    def __init__(self, client_id, client_secret, username, password, authorization_url, base_url) -> None:
    ...
    def _get_oauth_token(self) -> Union[SladeTokenResponseType, Dict]:
        ...
        frappe.log_error(
            payload, "SLADE OAUTHORIZATION PAYLOAD  /slade/slade.py")
        try:

            r = requests.post(self.OAUTH_BASE_URL, data=payload, headers={
    ...
    def verify_authorization(
        ...
        try:
            ...
            frappe.log_error(
                data, "SLADE AUTHORIZATION ERROR  /slade/slade.py")
    ...
    def submit_claim(self, data):
        ...
        try:
            ...
            frappe.log_error(e, "SLADE SUBMIT CLAIM ERROR  /slade/slade.py")
            frappe.log_error(
                data, "SLADE SUBMIT CLAIM ERROR  /slade/slade.py")
    ...
    def submit_invoice(
        ...
        try:
            ...
            r = requests.post(f"{self.BASE_URL}invoices/",
            ...
            frappe.log_error(
                data, "SLADE SUBMIT INVOICE ERROR  /slade/slade.py")
    ...
    def reserve_balance(self, data):
        try:
            ...
            r = requests.post(f"{self.BASE_URL}balances/reservations/reserve_from_authorization/",
                              json=data, headers=self.headers)
            ...
            frappe.log_error(
                data, "SLADE RESERVE BALANCE ERROR  /slade/slade.py")
    ...
    def upload_claim_attachment(self, data, file_path):
        try:
            ...
            r = requests.post(f"{self.BASE_URL}claim_attachments/upload_attachment/",
            ...
            frappe.log_error(
                data, "SLADE UPLOAD CLAIM ERROR  /slade/slade.py")
    ...
    def upload_invoice_attachment(self, data, file_path):
        try:
            ...
            frappe.log_error(
                data, "SLADE UPLOAD INVOICE REQUEST /slade/slade.py")
            r = requests.post(f"{self.BASE_URL}invoice_attachments/upload_attachment/",
                              files=files, data=data, headers=headers)
            response = r.json()
            ...
            frappe.log_error(
                data, "SLADE UPLOAD INVOICE ERROR  /slade/slade.py")
